    ...
    <>
      ...
      <div className="bg-blue-50 min-h-screen flex flex-col md:flex-row items-center text-center md:text-left px-6 md:px-20 py-10">
        <div className="md:w-1/2">
          ...
          <div className="flex flex-col mt-6 space-y-4 md:space-y-6">
            <Link
              to={"/products/1"}
              className="bg-blue-500 text-white text-center px-6 py-3 rounded-lg font-semibold hover:bg-blue-600"
            >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-700 text-lg mb-6">
              Achieve perfect results with Kings DTF Transfers by setting your
              heat press to <span className="font-semibold">160°C</span> and
              applying firm pressure for{" "}
              <span className="font-semibold">15 seconds</span>.
            </p>
            <Link
              to={"/HeatPress"}
              className="bg-blue-500 text-white font-semibold text-lg py-3 px-6 rounded-lg shadow-md hover:bg-blue-600 hover:shadow-xl transition-all"
            >
      ...
      <section className="w-full flex flex-col-reverse md:flex-row items-center justify-center gap-8 py-10 px-6 md:px-20">
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="font-bold text-2xl md:text-3xl pb-6">
            Join Us in Crafting DTF Innovations
          </h2>
          <p>
            Collaborate with us to revolutionize DTF printing, creating vibrant
            designs that inspire and elevate your brand. Together, let's shape a
            brighter future of custom apparel and merchandise
          </p>
        </div>
        <div className="md:w-1/2">
          <img
            src="/home/join_us.webp"
            alt="join us"
            className="rounded-lg shadow-lg w-full"
          />
        </div>
